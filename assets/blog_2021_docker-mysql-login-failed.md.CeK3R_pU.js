import{_ as t}from"./chunks/articleMetadata.CH2xeD7a.js";import{_ as c,C as o,c as b,o as p,j as l,G as u,at as m,a as d,w as h,b as y,e as k}from"./chunks/framework.CAzfEey9.js";import"./chunks/theme.CdwDD8CI.js";const L=JSON.parse('{"title":"Docker安装MySQL后无法登录","description":"用docker跑了一个mysql容器后，发现进入容器却无法成功登录，记录一下解决方案。","frontmatter":{"title":"Docker安装MySQL后无法登录","description":"用docker跑了一个mysql容器后，发现进入容器却无法成功登录，记录一下解决方案。","date":"2021-02-11T15:52:21.000Z","tags":["Docker","MySQL"]},"headers":[],"relativePath":"blog/2021/docker-mysql-login-failed.md","filePath":"posts/blog/2021/docker-mysql-login-failed/README.md","lastUpdated":1713953919000}'),g={name:"blog/2021/docker-mysql-login-failed.md"};function f(n,s,v,S,C,w){const i=t,r=o("ClientOnly");return p(),b("div",null,[s[0]||(s[0]=l("h1",{id:"docker安装mysql后无法登录",tabindex:"-1"},[d("Docker安装MySQL后无法登录 "),l("a",{class:"header-anchor",href:"#docker安装mysql后无法登录","aria-label":'Permalink to "Docker安装MySQL后无法登录"'},"​")],-1)),u(r,null,{default:h(()=>{var a,e;return[(((a=n.$frontmatter)==null?void 0:a.aside)??!0)&&(((e=n.$frontmatter)==null?void 0:e.showArticleMetadata)??!0)?(p(),y(i,{key:0,article:n.$frontmatter},null,8,["article"])):k("",!0)]}),_:1}),s[1]||(s[1]=m(`<h2 id="启动mysql容器" tabindex="-1">启动MySQL容器 <a class="header-anchor" href="#启动mysql容器" aria-label="Permalink to &quot;启动MySQL容器&quot;">​</a></h2><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --name</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mysql</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 3306:3306</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -e</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> MYSQL_ROOT_PASSWORD=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">***</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -v</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/data/docker/mysql:/var/lib/mysql</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mysql:5.6</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="发现错误" tabindex="-1">发现错误 <a class="header-anchor" href="#发现错误" aria-label="Permalink to &quot;发现错误&quot;">​</a></h2><ol><li>使用 Navicat 远程连接发现报 1045 错误</li><li>进入容器登录 mysql 发现仍然是<code>ERROR 1045 (28000): Access denied for user &#39;root&#39;@&#39;localhost&#39; (using password: YES)</code></li></ol><h2 id="解决问题" tabindex="-1">解决问题 <a class="header-anchor" href="#解决问题" aria-label="Permalink to &quot;解决问题&quot;">​</a></h2><p>这里说一下，在<a href="https://github.com/docker-library/mysql/issues/434" target="_blank" rel="noreferrer">https://github.com/docker-library/mysql/issues/434</a>这里看到相关问题</p><p>有人说使用 <code>mysql -uroot -p***</code> 即直接写出密码可以，我试过是不行的，这里贴出具体解决方案。</p><ol><li>进入容器中</li><li>使用命令 <code>/usr/bin/mysql_secure_installation</code></li><li>按照提示进行密码初始化即可</li></ol><p><strong>如下所示：</strong></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># /usr/bin/mysql_secure_installation</span></span>
